<?php
    ...
    if( isset($_GET["pid"]) ){
        ...
        $blockquoteValue = '<strong>Olá '. $usuario->getName() .'</strong>, preencha o formulário abaixo corretamente.';
    }
            ...
            <fieldset>
                <div class="widget first">    
                                ...
                                <li style="width: auto; float: none; border-top: 1px solid #e7e7e7; padding-top: 10px;">
                                    <div id="labelColorContainer">                        
                                        <select name="labelColor" class="validate[required]" style="width:300px">
                                            <option value="0">Selecione uma cor já cadastrada</option>
                                            <?php 
                    ...
                    <div class="rowElem">
                        ...
                        <div class="formRight">
                            <input type="text" style="width:15%" class="validate[required]" name="max_price" id="max_price" value="<?php print $row['max_price']; ?>" /> <span style="font-size:11px;">Ex. 10,00 (use vírgula)</span>
                        </div>
                        <div class="fix"></div>
                    </div>
